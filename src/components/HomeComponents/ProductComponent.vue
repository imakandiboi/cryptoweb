          ...
          <div class="card card-1 mb-3">
            <div class="card-body text-center">
              ...
              <p class="card-text">
                ...
                guarantee of future results. A Gemini Mastercard. Issued by
                WebBank. Terms apply.
              </p>
              ...
              <div class="card-button">
                ...
                <picture class="button-pic"
                  ><source
                    ...
                    type="image/avif"
                    srcset="
                      https://images.ctfassets.net/jg6lo9a2ukvr/1CfiSzsaaYfUpdoaXDr2uZ/ad1a596b5faed8ca54bcaddba656775c/arrow-btn.svg
                    " />
                  <source
                    media="(max-width: 767px)"
                    height="48"
